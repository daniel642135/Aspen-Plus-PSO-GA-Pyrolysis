...
tube_mat_velocity = 35 #m/s value by heuristics #initial appropriate guess
...
print(results3)
results4 = heat_exchanger_sizing2(Thi =Thi, Tho=Tho, Tci=Tci, Tco=Tco, Q=10639718, dint=dint_ft, N_tubes=results2['Number of tubes'], U=results2['U'])
print(results4)
